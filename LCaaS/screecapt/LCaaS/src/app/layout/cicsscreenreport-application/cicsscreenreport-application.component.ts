...
@Component({
    selector: 'app-cicsscreen-app',
    templateUrl: './cicsscreenreport-application.component.html',
    styleUrls: ['./cicsscreenreport-application.component.scss'],
    animations: [routerTransition()]
})

export class CicsScreenAppComponent implements OnInit {
  constructor(
