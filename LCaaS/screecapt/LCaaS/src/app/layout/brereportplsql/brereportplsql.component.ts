...
@Component({
    ...
    templateUrl: './brereportplsql.component.html',
    styleUrls: ['./brereportplsql.component.scss'],
    animations: [routerTransition()]
})

export class BreReportPlSqlComponent implements OnInit {
  ...
  componentList: any[] = [];
   ...
   dataSets: any = null;
    ...
    getBREDetailsNew(selectedType, selectedList, selectedProgram, intializeTable: boolean) {
      if (intializeTable) {
      this.dataservice.getBREPlSql2DetailsNew(selectedType, selectedList, selectedProgram).subscribe(res => {
