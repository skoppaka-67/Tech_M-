...
@Component({
    ...
    templateUrl: './programprocessflow-external.component.html',
    styleUrls: ['./programprocessflow-external.component.scss']
})


export class BsComponentExtComponent implements OnInit {
