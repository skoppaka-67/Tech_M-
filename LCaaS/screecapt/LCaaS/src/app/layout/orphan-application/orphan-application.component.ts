...
@Component({
    selector: 'app-orphanapp',
    templateUrl: './orphan-application.component.html',
    styleUrls: ['./orphan-application.component.scss'],
    animations: [routerTransition()]
})
export class OrphanAppComponent implements OnInit {
  constructor(
    ...
    ngOnInit() {
      ...
      this.dtOptions =  {
        ...
        this.getOrphanDetailsWithApp('', true);
    ...
    onSubmit(){
      ...
      this.getOrphanDetailsWithApp(this.selectedApplication, false);
      this.showLoader = false;
   }
   getOrphanDetailsWithApp(selectedApplication, initializeTbl: boolean) {
     if(initializeTbl){
      this.showLoader = true;
      this.dataservice.getOrphanDetailsWithApp('').subscribe(res => {
          this.dataSets = res;
          var dataJSON = {};
          var dataList = [];
      ...
      this.dataservice.getOrphanDetailsWithApp(this.selectedApplication).subscribe(res => {
          this.dataSets = res;
          var dataJSON = {};
          var dataList = [];
          var headerList = res.headers;
