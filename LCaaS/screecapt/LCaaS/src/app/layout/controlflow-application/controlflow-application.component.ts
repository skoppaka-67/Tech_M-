...
@Component({
    ...
    templateUrl: './controlflow-application.component.html',
    styleUrls: ['./controlflow-application.component.scss'],
    animations: [routerTransition()]
}) 
export class ControlFlowAppComponent implements OnInit {
