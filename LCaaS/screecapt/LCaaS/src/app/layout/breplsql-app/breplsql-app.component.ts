...
@Component({
    ...
    templateUrl: './breplsql-app.component.html',
    styleUrls: ['./breplsql-app.component.scss'],
    animations: [routerTransition()]
})

export class BrePlSqlAppComponent implements OnInit {
  ...
  componentList: any[] = [];
   ...
   dataSets: any = null;
    ...
    getBREDetailsNew(selectedType, selectedList, selectedProgram, selectedApplication,intializeTable: boolean) {
      if (intializeTable) {
      this.dataservice.getBREPlSqlDetailsNewWithApp(selectedType, selectedList,
