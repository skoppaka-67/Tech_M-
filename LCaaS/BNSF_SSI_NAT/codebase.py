...
#shfile ={ 'D:\\bnsf\\NAT_POC\\NAT': '*.NAT',"D:\\BNSF\\POC\\MAP":'*.MAP','D:\\BNSF\\POC\\PRM':'*.PRM',"D:\\BNSF\\POC\\DDM":'*.DDM','D:\\BNSF\\POC\\LDA':'*.LDA'}
shfile ={ file_path: '*.NAT',map_path:'*.MAP','D:\\BNSF\\POC\\PRM':'*.PRM',"D:\\BNSF\\POC\\DDM":'*.DDM','D:\\BNSF\\POC\\LDA':'*.LDA',copy_path:".CPY"}
