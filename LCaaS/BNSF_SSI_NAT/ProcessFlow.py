...
case = "caseq"
begin ="DEFINE"
search_element=["begsr","exsr","caseq","DEFINE"]
end = "END-SUBROUTINE"
call_sub = "exsr"
...
def read_lines(filename):
    ...
    for line in file_handle:
        ...
        try:
            ...
            if re.search(end, line) or (flag and re.search("RETURN", line)):  # counting lines
...
def main():
    ...
    for file_location, file_type in file.items():
        for filename in glob.glob(os.path.join(file_location, file_type)):
            ...
            #print(filename)
            # if filename==("TSXNCW01.NAT") or  filename== "WBMPEDI2.NAT":
            #     continue
