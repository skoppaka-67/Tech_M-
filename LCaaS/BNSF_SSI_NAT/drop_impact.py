...
def func1():
    try:
        ...
        extn['NATURAL-PROGRAM']='NATURAL-PROGRAM'
        # extn['MAP']='MAP'
        ...
        for drop in drop_impact:
            ...
            for ext in extn:
                ...
                if drop["component_type"] == ext:
                    var = drop["component_name"]
                    drop_dict = dict(drop_impact_name=drop_impact_name, drop_impact_type=drop_impact_type, orphan_component_name=var,application = "Unknown")
            ...
            for cpy in drop_impact_temp:
                ...
                if rep["drop_impact_name"] == cpy["drop_impact_name"] and rep["drop_impact_type"] == cpy["drop_impact_type"]:
                    ...
                    temp_dict = dict(drop_impact_name=cpy["drop_impact_name"],
                                   drop_impact_type=cpy["drop_impact_type"], orphan_component_name=temp_list,application = "Unknown")
