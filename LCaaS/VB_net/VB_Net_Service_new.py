...
def procedureFlowCompList():
    ...
    if option is not None:
        ...
        try:
            response = db.master_inventory_report.find({"application": application_name, "component_type": {
                "$in": ["WEBFORM", "USERCONTROL", "GLOBAL.ASAX", "MASTERPAGE", "CODEBEHIND", "VB"]}})
            if response is None:
                ...
                for event in payload['data'][program]:
                    ...
                    for item in node_set:
                        ...
                        for linkdict in pgm_name_1:
                            ...
                            elif (linkdict["name"] == "internal" or linkdict["name"] == "Webform") and linkdict[
                                "to"] == item[2:]:
        ...
        for i in table_connections:
            ...
            if i["component_name"].split('.')[0] == response['component_name']:  # inputcomponent:
                ...
                response["links"].append({"label": i["CRUD"],
                                          "source": "p_" + i["component_name"].split('.')[0] + "(" + i[
                                              "component_type"] + ")",
                                          "target": "p_" + i["Table"]})
...
def chartsAPI():
    ...
    try:
        ...
        for ite in cursor:
            ...
            OUTPUT_DATA['largest_applications_dead_code'][ite['_id']['application']] = count
            count = count - 1
...
def validationreport():
    ...
    data_object['headers'] = ["filename", "Application", "ScreenField", "Type", "propertyvalidation", "validators",
                              "CodeValidation"]
