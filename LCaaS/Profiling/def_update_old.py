...
def main(app_name,component_name):
    ...
    for comp in glossary_comp_list:
        ...
        bre_details = collection.find({"pgm_name":component_name}, {'_id': False}).sort('_id')
        ...
        try:
            db.bre_report2.delete_many({"pgm_name":component_name})
    ...
    for comp2 in glossary_comp_list:
        ...
        collection2 = db.translated_flowchart
