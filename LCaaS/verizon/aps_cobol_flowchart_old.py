...
#
#     # print("Kiran:",json.dumps(index_list, indent=4))
#
#     stnd_list = []
#     pop_list = []
...
for file_location, file_type in source_file.items():
    for filename in glob.glob(os.path.join(file_location,file_type)):
        # print(filename)
        process_list = endif_tagging_function(filename)
        ...
        for paragraph_name in para_list:
            ...
            #                         "component_name": filename.strip(file_location).replace(" ", "_") + file_type.strip(
            #                             ".*"),
            ...
            if dict == {}:
                ...
                OUTPUT_DATA.append({"option": node_string + '\n' + links_string,
                                    "component_name": filename.split("\\")[-1].replace(" ", "_"),
                                    "para_name": paragraph_name.casefold()})
