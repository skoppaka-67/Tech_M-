...
class flowchartProcessing(PreProcessing, Database):
    def __init__(self, DB_CON, pre_prop):
        super().__init__()
        cursy = DB_CON.Db_conn(config.vb6_dbname, "Pub_Fun_Lookup")
        ...
        for file in self.file_list:
            ...
            # print(json.dumps(code_block_dict,indent=4))
    ...
    def block_separation(self, code_block_dict, file_name):
        ...
        # Insert into DB
        try:
            DB_CON.db_update(config.vb6_dbname, "para_flowchart_data", OUTPUT_DATA)
            print('update sucess')
        except Exception as e:
            print('Error:' + str(e))
