...
def  varRelation(file_name):
    ...
    open_file=open(r'D:\WORK\IMS\DataD_lines.txt').readlines()
...
def grouping(file_entry):
    with open(file_entry,'r') as f:
        f1 =open(r"D:\WORK\IMS\DataD_lines.txt","w+")
...
for file_entry in file_list:
        ...
        os.remove(r'D:\WORK\IMS\DataD_lines.txt')
