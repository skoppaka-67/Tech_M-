...
def inout():
  ...
  # connections = db.cross_reference_report.find({"type": {'$ne': 'metadata'}})
  connections = db.cross_reference_report.find({"$and":[{"type": {'$ne': 'metadata'}},{"called_type":{'$ne': 'File'}},{"calling_app_name":{'$ne': 'Common Utility Modules'}},{"calling_app_name":{'$ne': 'New Prefix. Yet to get mapping'}},{"called_app_name":{'$ne': 'New Prefix. Yet to get mapping'}},{"called_app_name":{'$ne': 'Unknown'}},{"called_app_name":{'$ne': 'Common Utility Modules'}},{"called_type":{'$ne': 'Utility'}}]})
  calling_list = []
  called_list = []
  d = {}
  metadata = []
        ...
        for TYPE in COMPONENT_TYPES1:
            ...
            for type in comp_typ_list:
                for app in applist:
                    ...
                    out = dict(list(d_ascending.items())[0:5])
