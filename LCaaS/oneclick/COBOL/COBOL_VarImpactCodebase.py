...
component_types = {config.COBOL_codebase_information['COBOL']['folder_name']:config.COBOL_codebase_information['COBOL']['extension'],
                   config.COBOL_codebase_information['COPYBOOK']['folder_name']:config.COBOL_codebase_information['COPYBOOK']['extension'],
...
CopyPath=config.COBOL_codebase_information['code_location']+'//'+'COPYBOOK'
procpath=config.COBOL_codebase_information['code_location']+'//'+'PROC'
...
for component in component_types:
    ...
    if component == config.COBOL_codebase_information['COBOL']['folder_name'] or component == config.COBOL_codebase_information['COPYBOOK']['folder_name']:
