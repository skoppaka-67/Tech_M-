...
db1 = mongoClient["keywords"]
# db = mongoClient['BNSF_NAT_SSI']
# db1 = mongoClient["BNSF_NAT_SSI"]
...
def main():
    collection3 = db1.keyword_lookup_cobol
    ...
    #             replaced1 = re.sub(" " + dict['keyword'], " " + dict['Meaning'], flo_i['option'][17:], flags=re.IGNORECASE)
    #             flo_i['option'] = flo_i['option'] [:17] +replaced1
    #             # print(flo_i['option'])
    #
    #         else:
    #             if dict["keyword"]==" UPDATE( ":
    #                 replaced1 = re.sub(" "+" UPDATE\( ", " " +"  update the recent record selected  ", flo_i['option'], flags=re.IGNORECASE)
    ...
    try:
        db.bre_rules_report.delete_many({})
