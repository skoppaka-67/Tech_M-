...
cobol_extension_type = config.codebase_information['NATURAL']['extension']
...
def main():
 ...
 wb1 = xlrd.open_workbook("C:\\Users\\Kiran Koppaka\\PycharmProjects\\Lcass\\TW_POC_BRE\\Book2.xlsx")
 ...
 for filename in glob.glob(os.path.join(CobolPath,'*.NAT')):
    ...
    if counter1==1: # number of files to update in DB
        counter1=0
               ...
               if module != [] or module_1!=[]:
                   ...
                   if firstword in Key_Word_List or (firstword.startswith('#') and not if_line_flag) or variable_flag:
                      ...
                      if onelinebuffer!=[]:
                        ...
                        if line5.startswith("IF") and firstword.startswith('#') :
                            if line5.__contains__('/*'):
                                split_line=line5.split('/*')[0]
    ...
    #     with open("Duplicatefile5" + str(i) + '.txt', "a+") as space_line1:
    #
    ...
    for line in file_handle:
        ...
        try:
                ...
                if line.strip() =="":
                    ...
                    #print("Copy_expanded lines:", line)
                    if (re.search(end, line) or re.search("RETURN", line) or re.search("DEFINE SUBROUTINE.*",line)) : # counting lines
