...
def main(filename,metadata):
      ...
      try:
                ...
                if data["ScreenField"] == control_id.strip():
                    ...
                    for condition_data_line_1 in condition_split_list:
                        ...
                        if condition_data_line.upper().strip().startswith("IF") or condition_data_line.upper().strip().startswith("SELECT ") or \
                            ...
                            data1={"function_name":data["function_name"],"ScreenField":data["ScreenField"],"SectionName":db_screen_data["SectionName"],"CLASLabel":db_screen_data["CLASLabel"],"rule_id": "rule-" + str(rule),"rule_statement":condition_data_line_1, "Rule_Relation": ",".join(parent_rule_id), "rule_description": "",
                            ...
                            db.rule_report.insert_one(
                                {"function_name":data["function_name"],"ScreenField":data["ScreenField"],"SectionName":db_screen_data["SectionName"],"CLASLabel":db_screen_data["CLASLabel"],"rule_id": "","rule_statement":condition_data_line_1, "Rule_Relation": ",".join(parent_rule_id), "rule_description": "",
                        ...
                        if control_id_dup in line1:
                            ...
                            for condition_data_line_1 in condition_split_list:
                                ...
                                if condition_data_line.upper().strip().startswith(
                                    ...
                                    data1 = {"function_name": data["function_name"], "ScreenField": control_id,"SectionName":db_screen_data["SectionName"],"CLASLabel":db_screen_data["CLASLabel"],
                                    ...
                                    db_screen_data = db.screen_data.find_one({"ScreenField":control_id})
                                    db.rule_report.insert_one(
                                        {"function_name": data["function_name"], "ScreenField": control_id,"SectionName":db_screen_data["SectionName"],"CLASLabel":db_screen_data["CLASLabel"],
        ...
        with open("rule_report_final" + '.csv', 'w', newline="") as output_file:
            Fields = ["rule_id","file_name","function_name","ScreenField","SectionName","CLASLabel","rule_statement","Rule_Relation","rule_description","rule_type","lob","dependent_control","parent_rule_id","External_rule_id"]
   ...
   try:
    ...
    with open(filename+'.vb','r') as input_file:
        ...
        for line in end_if_handled:
            ...
            function_name4_regexx = re.findall(r'^\s*PRIVATE\s*FUNCTION\s*[A0-Z9_]*[(].*', line, re.IGNORECASE)
            ...
            if function_name_regexx != [] or function_name_3_regexx !=[] or function_name_2_regexx !=[] or function_name4_regexx !=[]:
                ...
                elif function_name4_regexx!=[]:
                    fun_value=function_name4_regexx
            ...
            if end_select_regexx !=[] and select_data_list!=[]:
                ...
                if select_counter==0:
                    metadata.append(
                        {"function_name": function_name, "ScreenField": cid_name, "rule_statement": select_data_list,
            ...
            if end_if_regexx != [] and if_data_list !=[]:
                ...
                if if_counter == 0:    # At the end of condition , appedning the captured data to global list named as metadata.
                    ...
                    metadata.append(
                          {"function_name": function_name, "ScreenField": cid_name, "rule_statement": if_data_list,"file_name":filename.split('\\')[-1].split('.')[0]})
                    if_data_list = []
...
def classification_of_if(data):
  ...
  try:
   ...
   for line_2 in data["rule_statement"]:
       ...
       if (line_2.strip().startswith("If ") or line_2.strip().startswith("If(")) and (line_2.strip().endswith(' Then') or line_2.strip().__contains__(' Then')) \
               or line_2.strip().startswith("ElseIf ") :
           if_statement_string=line_2.strip()
           break
       elif (line_2.strip().startswith("If ") or line_2.strip().startswith("If(")) or line_2.strip().startswith("ElseIf ") and not line_2.strip().endswith(' Then'):
  ...
  try:
   ...
   if if_value.strip().__contains__(" HashSet") and  if_value.strip().__contains__("Contains"):
       ...
       if (single_if_statement.__contains__(".Input(") or single_if_statement.__contains__(".Fields(")) and \
            ...
            if if_statement_input_value.strip().startswith('"') or (if_statement_input_value.upper() in boolean_list):
           ...
           if if_statement_input_value_1.startswith('(') and if_statement_input_value_1.endswith(')'):
                if if_statement_input_value_1[:-1].endswith(')') and not if_statement_input_value_1[1:-1].__contains__('('):
                    if_statement_input_value_1 = if_statement_input_value_1[1:-2]
                elif if_statement_input_value_1.__contains__('.'):
                    if_statement_input_value_1=if_statement_input_value_1[1:-1]
                elif if_statement_input_value_1.startswith('(') and if_statement_input_value_1.endswith(')') and not if_statement_input_value_1.__contains__('.)'):
           ...
           elif not left_if_statement_input_value_1.startswith('(') and not left_if_statement_input_value_1.endswith(')'):
           ...
           elif not left_if_statement_input_value_1.strip().startswith('(') and left_if_statement_input_value_1.strip().endswith(')'):
           ...
           elif left_if_statement_input_value_1.startswith('(') and not left_if_statement_input_value_1.strip().endswith(')'):
           ...
           if single_if_statement.split('.')[0].strip().startswith('(') and not single_if_statement.split('.')[0].strip().endswith(')'):
  ...
  try:
    ...
    if if_cursor_1!=[]:
        for data_2 in if_cursor_1["rule_statement"]:
            ...
            if data_2.split("=")[0].__contains__(name_val_var) and data_2.__contains__(
                    "=") and not data_2.strip().startswith('If ') and not data_2.strip().split()[-1].upper() in boolean_list:
               inside_flag=True
    ...
    if not inside_flag:
        ...
        for data_1 in if_cursor["source_statement"]:
            ...
            if not name_val_var.startswith(' '):
                name_val_var=' '+name_val_var
            if data_1.split("=")[0].__contains__(name_val_var) and data_1.__contains__("=") and not data_1.strip().startswith('If ') :
  ...
  try:
    ...
    if not inside_flag:
        ...
        for data_1 in if_cursor["source_statement"]:
            if data_1.strip()=="" or data_1.strip().startswith("'"):
                continue
            if data_1.split("=")[0].__contains__(name_val_var) and data_1.__contains__("=") and not data_1.strip().startswith('If ') and not data_1.strip().split()[-1].upper() in boolean_list:
        ...
        if left_multi_line_list!=[]:
            ...
            if any(item in ' '.join(left_multi_line_list).split() for item in ['AndAlso','OrElse','Or','And']):
                if ' '.join(left_multi_line_list).__contains__('='):
                     multi_line_list_value= ' '.join(left_multi_line_list)[' '.join(left_multi_line_list).index('=')+1:]
                else:
  ...
  try:
    ...
    with open(filename + '.vb', 'r') as vb_file:
        for lines in reversed(vb_file.readlines()):
                            ...
                            for db_data in if_cursor:
                               for rule_line in db_data['rule_statement']:
                                   ...
                                   if rule_variable.__contains__(
                                       ' '+if_statement_string.split('(')[0]+' ') and rule_line.__contains__("="):
                                            rule_flag=True
                                            rule_data=db_data
                                            global counter
                                            counter=counter+1
                            ...
                            if not rule_flag:
                                   ...
                                   if assignment_line=="":
                                       ...
                                       if assignmanet_flag and not inside_flag:
                                           dup_data_rule=dup_data["rule_statement"]
                                           dup_data_rule.insert(0,"Page_Load():"+assignment_line_1.replace('\n',''))

                                           db.rule_report.update_one({"_id":dup_data["_id"]},{"$set":[{"rule_statement":dup_data_rule},{"rule_type": "variable_type_rule"}]},upsert=True)
                                       ...
                                       if any(item in assignment_line.split() for item in
                                           ...
                                           variable_back_trace_fun(" If " + multi_line_list_value_1 + ' Then', dup_data)

                                       dup_data_rule.insert(0, fun_value_1.strip()+'():'+" ".join(multi_line_list_1))
                                       varaible_flag = True
                                       db.rule_report.update_one({"_id": dup_data["_id"]},
                                                                 {"$set": {"rule_statement": dup_data_rule,
                                                                           "rule_type":"variable_type_rule"}})
            ...
            if (function_name_regexx!=None or function_name_1_regexx!=None or function_name_2_regexx!=None) and lines_flag :
                lines_flag = False
                            ...
                            if not rule_flag:
                                   ...
                                   if assignment_line=="":
                                       ...
                                       if any(item in assignment_line.split() for item in
                                           ...
                                           left_variable_back_trace_fun(" If " + multi_line_list_value_1 + ' Then', dup_data)
    ...
    for lines in full_function_data:
        ...
        for in_line in lines["source_statement"]:
          ...
          if (in_line.strip().startswith("Private ") and in_line.__contains__(" Sub ")) or (in_line.strip().startswith("Public ") and in_line.__contains__(" Shared ") and
              in_line.__contains__(" Function ")) or (in_line.strip().startswith("Public ") and in_line.__contains__(" Sub ")) or in_line.strip().upper().startswith("IF") or in_line.strip().upper().startswith("CASE ") or \
              ...
              for rec_data in rules_lines:
                  for k in rec_data["rule_statement"]:
                      if (k.strip().startswith("Private ") and k.__contains__(" Sub ")) or (
                              ...
                              k.__contains__(" Function ")) or (k.strip().startswith("Public ") and k.__contains__(" Sub "))or k.strip().upper().startswith(
...
def Function_processer(dup_data):
    ...
    external_fun_cur = db.master_rules_report.distinct("Function_name", (
        {"Function_type": "PBS", "File_name": dup_data["file_name"].split(".")[0]}))
