...
def main():
            ...
            for dict in key_word_json_object:
                if bre_i['rule_description'].__contains__(dict['Variable']):
                    ...
                    if  dict['Business_Meaning'] == "":
                        ...
                        replaced1 = re.sub(dict['Variable'], " "+dict['Business_Meaning']+" ", bre_i['rule_description'].strip())
    ...
    for bre_js in js_bre_json_objects:
        try:
            ...
            bre_js['rule_description'] = bre_js['rules_statement']

            for dict in js_key_word_json_object:
                if bre_js['rule_description'].__contains__(dict['Variable']) :
                    ...
                    if  dict['Business_Meaning'] == "":
                        ...
                        replaced1 = re.sub(dict['Variable'], " "+dict['Business_Meaning']+" ", bre_js['rule_description'].strip())
                        # replaced1 = re.sub(dict['Variable']+".", dict['Business_Meaning']+".", bre_js['rule_description'].strip())
