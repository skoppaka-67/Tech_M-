...
def main(filename,metadata):
      ...
      try:
        ...
        with open("LOC_rule_report" + '.csv', 'w', newline="") as output_file:
            ...
            if object_fun == False:
                ...
                if matches3 != []:
                    for match in matches3:
                        ...
                        cursor1 = db.master_rules.find({"function_name": calling_function_name, "Function_Type": "PS",
                                                        }, {'_id': 0})
