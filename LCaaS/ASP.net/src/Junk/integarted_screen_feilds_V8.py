...
keywords_for_check_stored = ['Yes"', 'No"', '"Y"', '"N"', 'Status.YES_ABBREIVATED', 'Status.NO_ ABBREIVATED',
                             'Constants.SHORT_Yes', 'Constants.SHORT_No',
               ...
               if content.lower().__contains__("datasource"):
                   ...
                   if (content.split("=")[-1].strip().lower().__contains__("datasource")):
                       ...
                       for l in storage:
                           ...
                           l.split("=")[-1].lower().__contains__("datasource")):# To check refrence variable present in with the SUB or not
