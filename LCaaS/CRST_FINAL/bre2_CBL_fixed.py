...
### FINAL VERSION of BRE-2 after fixing para name issue and Evaluate.
...
def main():
    ...
    ignore_list = ['NA20AAAK.']

    for component in compnentname_list:

        if component in ignore_list  or component.strip(".") in bre_complist:
        ...
        for index,i in enumerate(Meatadata,1):
                ...
                rule_relation = ""
                # print(bre2_json)
                bre2_json = {"fragment_id": component.strip(".")+"-"+str(index),"pgm_name": pgmname.replace(".",""), "para_name": paraname, "source_statements": source_statements,'rule_category':" ", 'Rule': Rule,
