...
def  varRelation(file_name):
    ...
    open_file=open(r'D:\CRST_FULL\DataD_lines.txt').readlines()
    ...
    for lines in range(len(open_file)):
        ...
        try:
            ...
            # print("lksdjfsdklf",(open_file[lines][6:].strip().split()), lines)
            i=1
            d={}
...
def grouping(file_entry):
    with open(file_entry,'r') as f:
        f1 =open(r"D:\CRST_FULL\DataD_lines.txt","w+")
...
for file_entry in file_list:
        ...
        os.remove(r'D:\CRST_FULL\DataD_lines.txt')
